...
- Tussenversie `e166ae4` is eerder verspreid (iOS #64 / Android #62). De serverblokkade is verholpen en de definitieve interne testdistributie op `e4885da` is hervat. iOS Release #65 was vóór publiceren geannuleerd. Nieuwe workflows: [iOS Release #66](https://codemagic.io/app/69f36f732d8b59f24897933a/build/6ab281da88dc8aaeb5087050) **geslaagd: versie 1.5.0 (99), upload door Apple zonder fouten geaccepteerd**. Beschikbaarheid in TestFlight na verwerking is nog niet bevestigd. [Android Test #63](https://codemagic.io/app/69f36f732d8b59f24897933a/build/6ab281da31d4c516db3a982a) is gestart na de iOS-build en draait nog; publiceren naar de interne Play-track is nog niet bevestigd. De officiële externe test blijft afhankelijk van de vrijgavevoorwaarden.
